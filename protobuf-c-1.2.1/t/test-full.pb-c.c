...
{
  static Foo__SubMess__SubSubMess init_value = FOO__SUB_MESS__SUB_SUB_MESS__INIT;
  *message = init_value;
}
...
{
  static Foo__TestMessOneof init_value = FOO__TEST_MESS_ONEOF__INIT;
  *message = init_value;
}
...
{
  static Foo__LowerCase init_value = FOO__LOWER_CASE__INIT;
  *message = init_value;
}
...
{
  static Foo__TestRequiredFieldsBitmap init_value = FOO__TEST_REQUIRED_FIELDS_BITMAP__INIT;
  *message = init_value;
}
...
{
  static Foo__TestFieldFlags init_value = FOO__TEST_FIELD_FLAGS__INIT;
  *message = init_value;
}
...
{
  static Foo__TestMessageCheck__SubMessage init_value = FOO__TEST_MESSAGE_CHECK__SUB_MESSAGE__INIT;
  *message = init_value;
}
void   foo__test_message_check__init
                     (Foo__TestMessageCheck         *message)
{
  static Foo__TestMessageCheck init_value = FOO__TEST_MESSAGE_CHECK__INIT;
  *message = init_value;
}
...
{
  static Foo__TestMessSubMess init_value = FOO__TEST_MESS_SUB_MESS__INIT;
  *message = init_value;
}
...
static const ProtobufCFieldDescriptor foo__sub_mess__sub_sub_mess__field_descriptors[4] =
{
  {
    "val1",
    1,
