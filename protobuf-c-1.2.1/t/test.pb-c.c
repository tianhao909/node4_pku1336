...
{
  static Foo__Person__PhoneNumber init_value = FOO__PERSON__PHONE_NUMBER__INIT;
  *message = init_value;
}
void   foo__person__init
                     (Foo__Person         *message)
{
  static Foo__Person init_value = FOO__PERSON__INIT;
  *message = init_value;
}
...
{
  static Foo__LookupResult init_value = FOO__LOOKUP_RESULT__INIT;
  *message = init_value;
}
...
void   foo__name__init
                     (Foo__Name         *message)
{
  static Foo__Name init_value = FOO__NAME__INIT;
  *message = init_value;
}
